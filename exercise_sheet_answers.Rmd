...
In being singular, the matrix does not have an inverse meaning that the corresponding linear equations have either no, or unlimited solution. Regardless, in this case, the initial equations have no unique solution for η. 
