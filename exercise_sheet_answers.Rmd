...
As previously discussed, the proability that Alice and Ben both miss in a given round is: $(1 - α)\times (1-β)$

\
This could repeat n times where n can denotes any integer (theoretically): $((1 - α)\times (1-β))^n$

\
Eventual success from Alice (given that she throws first) therefore gives: $((1 - α)\times (1-β))^{n-1} \timesα$

This is because $α$ still denotes the probability that she will hit successfully.

\
Therefore, substituting my terms in gives:

$P_{1} = (1-α)\times(1-β)^{n-1}\times α$
