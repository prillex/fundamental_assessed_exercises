...
The number of B supporters at the end of day 1 will be the inital supporters - those that switch allegiance to support M + those that switch allegiance to support B:

$$
\text{B supporters after 1 day} = 175 - P(B > M) + P(M > B) NEED TO INCLUDE THE N HERE
$$
