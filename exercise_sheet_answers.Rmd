...
The tins' weight follows a normal distribution: $X\text~N(μ = 426, σ = 21)$. I need to calculate the the expectation of a fine (true when weight \< 420.75). This is equivalent to the CDF $F(x) = P(X ≤ 420.75)$.
...
The corresponding CDF cannot be denoted analytically but must be evaluated. The CDF $F(x) = P(X ≤ 420.75)$ is the integral of the PDF.
