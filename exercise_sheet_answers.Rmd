...
The summary of the model which including the three fixed explanatory effects highlights the extent of their relationship with ozone (ppb). Firstly, the effect of temperature is positive as expected; the estimate is 1.6 which means that for every increase in 1 degrees Fahrenheit there is an associcated increase in ozone of 1.6 ppb. This supports the initial expectations. This relationship is statstically significant at the 0.05 significance threshold (used for all future analsyes), (p \<0.0001). This was the most significant result which I also predicted given the initial visualisation.
...
Next, the assumption of linearity in the residuals has also been violated. This can be seen in the Q-Q plot whereby a number of residuals deviate from the expected linear distribution (along the dotted line). This is most apparent when looking at the data point from the 77th day.
...
In conclusion, the model's reliability is limited in some respect. Namely, the lack of homoscedascity and linearity in the residuals limits the validity of inferring the results of the model. \
\
\
\##
